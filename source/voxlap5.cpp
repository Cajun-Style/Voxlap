...
int64_t gi, gcsub[8] =
{
	0xff00ff00ff00ffll,0xff00ff00ff00ffll,0xff00ff00ff00ffll,0xff00ff00ff00ffll,
	0xff00ff00ff00ffll,0xff00ff00ff00ffll,0xff00ff00ff00ffll,0xff00ff00ff00ffll
};
...
void print4x6 (ptrdiff_t x, ptrdiff_t y, int32_t fcol, int32_t bcol, const char *fmt, ...)
{
	...
	y = y*bytesperline+(x<<2)+frameplace;//? Why an offset of x<<2?
	if (bcol < 0)//??? background colour -1 means transparent
	{
		for(j=20;j>=0;y+=bytesperline,j-=4)
			for(c=st,x=y;*c;c++,x+=16)
			{
				i = (font4x6[*c]>>j);
				if (i&8) *(uint32_t *)(x   ) = fcol;
				if (i&4) *(uint32_t *)(x+ 4) = fcol;
				if (i&2) *(uint32_t *)(x+ 8) = fcol;
				if (i&1) *(uint32_t *)(x+12) = fcol;
				if ((*c) == 9) x += 32;
			}
		return;
	}
	...
	for(j=20;j>=0;y+=bytesperline,j-=4)
		...
		{
			i = (font4x6[*c]>>j);
			*(uint32_t *)(x   ) = (((i<<28)>>31)&fcol)+bcol;
			*(uint32_t *)(x+ 4) = (((i<<29)>>31)&fcol)+bcol;
			*(uint32_t *)(x+ 8) = (((i<<30)>>31)&fcol)+bcol;
			*(uint32_t *)(x+12) = (((i<<31)>>31)&fcol)+bcol;
...
{
	0x3E00000000000000ull,0x6F6B3E003E455145ull,0x1C3E7C3E1C003E6Bull,0x3000183C7E3C1800ull,
	0x7E5C180030367F36ull,0x000018180000185Cull,0x0000FFFFE7E7FFFFull,0xDBDBC3FF00000000ull,
	0x0E364A483000FFC3ull,0x6000062979290600ull,0x0A7E600004023F70ull,0x2A1C361C2A003F35ull,
	0x0800081C3E7F0000ull,0x7F361400007F3E1Cull,0x005F005F00001436ull,0x22007F017F090600ull,
	0x606060002259554Dull,0x14B6FFB614000060ull,0x100004067F060400ull,0x3E08080010307F30ull,
	0x08083E1C0800081Cull,0x0800404040407800ull,0x3F3C3000083E083Eull,0x030F3F0F0300303Cull,
	0x0000000000000000ull,0x0003070000065F06ull,0x247E247E24000307ull,0x630000126A2B2400ull,
	0x5649360063640813ull,0x0000030700005020ull,0x00000000413E0000ull,0x1C3E080000003E41ull,
	0x08083E080800083Eull,0x0800000060E00000ull,0x6060000008080808ull,0x0204081020000000ull,
	0x00003E4549513E00ull,0x4951620000407F42ull,0x3649494922004649ull,0x2F00107F12141800ull,
	0x494A3C0031494949ull,0x0305097101003049ull,0x0600364949493600ull,0x6C6C00001E294949ull,
	0x00006CEC00000000ull,0x2400004122140800ull,0x2241000024242424ull,0x0609590102000814ull,
	0x7E001E555D413E00ull,0x49497F007E111111ull,0x224141413E003649ull,0x7F003E4141417F00ull,
	0x09097F0041494949ull,0x7A4949413E000109ull,0x00007F0808087F00ull,0x4040300000417F41ull,
	0x412214087F003F40ull,0x7F00404040407F00ull,0x04027F007F020402ull,0x3E4141413E007F08ull,
	0x3E00060909097F00ull,0x09097F005E215141ull,0x3249494926006619ull,0x3F0001017F010100ull,
	0x40201F003F404040ull,0x3F403C403F001F20ull,0x0700631408146300ull,0x4549710007087008ull,
	0x0041417F00000043ull,0x0000201008040200ull,0x01020400007F4141ull,0x8080808080800402ull,
	0x2000000007030000ull,0x44447F0078545454ull,0x2844444438003844ull,0x38007F4444443800ull,
	0x097E080008545454ull,0x7CA4A4A418000009ull,0x0000007804047F00ull,0x8480400000407D00ull,
